...
from excel import *
from json_utils import save_order_to_json,save_spend_to_json
...
PRODUCT_NAMES = {
    ...
    "MOR15000": "Мор 15000",
    "SAM8000": "Самса 8000",
    "SAM2X15000": "Самса 2X -15000",
    "SAMSA6000": "Самса 6000",
    "KSAMSA8000": "Кур. САМСА 8000",
    "KSAMSA15000": "Кур. САМСА 15000",
...
async def handle_comment_for_spend(msg: Message, state: FSMContext):
    ...
    user_id = msg.from_user.id
    save_spend_to_json(user_id=user_id, spend_amount=amount, comment=comment)
